 ...
 * Used in the 3-column expertise section
 */
...
export function ExpertiseCard({ icon, title, description }: ExpertiseCardProps) {
  return (
    <article className="card card-hover group">
      {/* Icon Container */}
      <div className="w-14 h-14 rounded-xl bg-accent/10 dark:bg-accent-dark/10 flex items-center justify-center mb-6 group-hover:bg-accent/20 dark:group-hover:bg-accent-dark/20 transition-colors">
        <div className="w-7 h-7 text-accent dark:text-accent-dark">
          {icon}
        </div>
      </div>
...
// Pre-built Icons for expertise areas
