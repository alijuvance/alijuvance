            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-gray-100 dark:border-white/5">
              <div className="flex flex-wrap gap-2">
                {project.stack.map((tech) => (
                  <span key={tech} className="px-2 py-1 text-xs font-mono rounded bg-gray-100 dark:bg-zinc-800/50 text-secondary dark:text-zinc-400 border border-gray-200 dark:border-white/10">
                    {tech}
                  </span>
                ))}
              </div>
