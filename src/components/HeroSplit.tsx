...
export function HeroSplit() {
  ...
  return (
    <section id="about" className="relative w-full min-h-[85vh] flex items-center justify-center overflow-hidden pt-20 pb-10">
      <div className="container-section grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          ...
          <p className="text-sm font-mono font-bold tracking-[0.2em] text-secondary uppercase mb-6">
            {t('hero.pre')}
          </p>
