...
export const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'contact.start': 'Envoyer un message',
    'contact.name': 'Votre nom',
    'contact.name.ph': 'Veuillez saisir votre nom complet',
    'contact.email': 'Adresse courriel',
    'contact.email.sub': 'Réponse sous 24 heures',
    'contact.type': 'Sujet',
    'contact.type.ph': 'Le sujet de votre message',
    'contact.details': 'Message',
    'contact.details.ph': 'Votre message ici...',
    ...
    'contact.whatsapp.sub': 'Messagerie et appels rapides',
    ...
    // Footer
    'footer.bio': "Créer des expériences numériques qui font la différence. Toujours enthousiaste à l'idée de relever de nouveaux défis et de concevoir des solutions innovantes.",
    'footer.services': 'Services',
    'footer.links': 'Liens rapides',
    'footer.why': 'Pourquoi moi ?',
    'footer.copyright': '© 2025 Ali Juvance. Tous droits réservés.',
  ...
  en: {
    ...
    'contact.email.sub': 'Response within 24 hours',
    'contact.type': 'Subject',
    'contact.type.ph': 'Subject of your message',
    'contact.details': 'Message',
    'contact.details.ph': 'Your message here...',
    ...
    'contact.whatsapp.sub': 'Quick messaging and calls',
    ...
    'footer.why': 'Why Me?',
    'footer.copyright': '© 2025 Ali Juvance. All rights reserved.',
