...
export function Preloader() {
  ...
  useEffect(() => {
    // Simulate loading time - adjust as needed or bind to real loading state
      ...
      >
        ...
        <div className="relative flex items-center justify-center gap-2 h-40">
          {bars.map((bar, i) => (
            <motion.div
              key={i}
              className="w-2 md:w-3 rounded-full bg-white shadow-[0_0_20px_rgba(255,50,50,0.6)]" // Stronger red glow
