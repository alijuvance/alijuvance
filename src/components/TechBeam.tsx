           ...
           <div className="relative">
             ...
             <div className="relative p-3 rounded-xl bg-[#0f0f10] border border-white/10 shadow-2xl flex flex-col items-start gap-1">
                <div className="grid grid-cols-2 gap-1.5 mt-1 w-full">
                   ...
                   <div className="flex items-center justify-center px-3 py-1.5 rounded-sm bg-rose-500/10 border border-rose-500/20 text-[10px] font-bold text-rose-400 tracking-wider shadow-[0_0_10px_-5px_rgba(244,63,94,0.3)] hover:scale-105 transition-transform duration-300">TOOLS</div>
