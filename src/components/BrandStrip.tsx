...
const brands = [
  ...
  { 
    ...
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
         <path d="M12 4.5a2.5 2.5 0 0 0-2.5 2.5v.9a4.5 4.5 0 0 0-3.2 2H5a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h2.5a4.5 4.5 0 0 0 1.9 1.9v.6a2.5 2.5 0 0 0 5.0 0v-.6a4.5 4.5 0 0 0 1.9-1.9H19a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-1.3a4.5 4.5 0 0 0-3.2-2v-.9a2.5 2.5 0 0 0-2.5-2.5zM9 12a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
      </svg>
    ) 
  },
];
