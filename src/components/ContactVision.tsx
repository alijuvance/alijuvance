        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 p-8 rounded-2xl bg-[#0f0f10] border border-white/5">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              {/* Captcha Mockup */}
              <div className="p-3 bg-white text-black rounded w-fit flex items-center gap-3">
                <div className="w-6 h-6 border-2 border-gray-300 rounded inline-block" />
                <span className="text-sm font-medium">Je ne suis pas un robot</span>
              </div>

              <button className="w-full py-4 rounded-xl bg-accent hover:bg-accent/90 text-white font-bold transition-colors flex items-center justify-center gap-2">
