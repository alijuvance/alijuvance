             ...
             {isActive ? (
               ...
               >
                 ...
                 <div className="flex items-center justify-between pt-3 border-t border-white/5">
                   ...
                   <a href="https://github.com/alijuvance" target="_blank" rel="noopener noreferrer" className="group/github p-2 rounded-full border border-red-500/20 bg-red-500/5 hover:bg-red-500/10 hover:border-red-500/40 hover:scale-110 transition-all duration-300 shadow-[0_0_15px_-5px_rgba(239,68,68,0.2)] cursor-pointer">
